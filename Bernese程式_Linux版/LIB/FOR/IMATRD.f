...
C*
      SUBROUTINE IMATRD(RCS,N,M,IDEL,MAT,NNEW,MNEW)
CC
CC NAME       :  IMATRD
CC
CC PURPOSE    :  (A) RCS = 'R'
...
CC                   INTEGER*4 N*N MATRIX
CC                   IF IDEL(I)=1, COLUMN AND ROW I ARE DELETED.
CC
CC                NNEW, MNEW ARE THE DIMENSIONS OF THE RESULTING MATRIX
CC
CC PARAMETERS :
CC         IN :  RCS    : OPTION SELECTION (SEE ABOVE)        CH*1
CC               N        NUMBER OF ROWS                      I*4
CC               M        NUMBER OF COLUMNS                   I*4
CC               IDEL(I),I=1,2,...,N OR M (SEE ABOVE)         I*4(..)
CC     IN/OUT :  MAT(I),I=1,2,...,N*M OR N*(N+1)/2            I*4(..)
...
CC
CC CREATED    :  87/11/02 12:13
CC
CC CHANGES    :  18-OCT-93 : EB: CORRECT ELIMINATION IN CASE (A)
