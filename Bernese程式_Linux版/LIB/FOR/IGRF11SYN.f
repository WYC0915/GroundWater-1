...
C
C ==============================================================================
C BERNESE GPS SOFTWARE VERSION 5.1
C ==============================================================================
C
C PURPOSE:
C
C AUTHORS:
C
C CREATED:    02-FEB-10 (http://www.ngdc.noaa.gov/IAGA/vmod/igrf11.f)
C
C CHANGES:    02-FEB-10 : SL: ADAPTED FOR BSW
C             05-FEB-10 : SL: WRITE STATEMENTS TO LFNERR AND ONLY ONCE
C
C COPYRIGHT:  ASTRONOMICAL INSTITUTE
...
c
      ...
      if (date.gt.2015.0) then
        if (.not. msg1) then
          write (lfnerr,960) date
          msg1 = .true.
        endif
      endif
